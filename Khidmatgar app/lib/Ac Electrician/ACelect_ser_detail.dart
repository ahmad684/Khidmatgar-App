...
class _AcElectricianServicesDetailState extends State<AcElectricianServicesDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text("AC Electric Service",
            ...
            child: Column(
              children: [
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => VehariACElectricShop()));
                  },
                ),
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => BurewalaACElectricShop()));
                  },
                ),
              ],
            ),
